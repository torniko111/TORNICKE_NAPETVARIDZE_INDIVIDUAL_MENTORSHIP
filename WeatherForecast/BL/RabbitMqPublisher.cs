...
namespace BL
{
    public class RabbitMqPublisher : IRabbitMqPublisher
    {
        ...
        public RabbitMqPublisher(IPublishEndpoint publishEndpoint, UserManager<ApplicationUser> userManager, IWeatherRepository weatherRepository, IConfiguration config)
        {
